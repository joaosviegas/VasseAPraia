...
const InteractiveMap = ({onConcelhoSelect}) => {
  ...
  const regions = [
    ...
    },
    {
        ...
        name: "Ponta do Sol",
        beaches: 10,
        description: "Praia de calhau e acesso ao mar",
    ...
    },
    {
        ...
        name: "Calheta",
        beaches: 10,
        description: "Praia de Areia Branca e natureza",
    ...
    },
    {
        ...
        name: "São Vicente",
        beaches: 10,
        description: "Praias de calhau e natureza",
    ...
    },
    {
        ...
        name: "Santana",
        beaches: 10,
        description: "Cultutra Madeirense e casas típicas",
    ...
    },
    {
        ...
        name: "Machico",
        beaches: 10,
        description: "Praia de areia dourada e história",
    ...
    },
    {
        ...
        name: "Porto Santo",
        beaches: 10,
        description: "Praias de areia dourada",
        ...
        <svg className="interactive-areas" viewBox="0 0 801 373">
          {regions.map(region => (
            <React.Fragment key={region.id}>
              <path
                d={region.path}
                className={`region-area ${activeRegion?.id === region.id ? 'active' : ''}`}
                onMouseEnter={(e) => {
                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      <foreignObject
                        x={tooltipX}
                        y={activeRegion.tooltipPosition.y - 50}
                        width="180"
                        height="100"
                      >
                        <div className="region-tooltip">
                          <div className="tooltip-content">
                            ...
                            {activeRegion.beaches && (
                              <p className="tooltip-beaches">{activeRegion.beaches} praias nesta região</p>
                            )}
                            {activeRegion.description && (
                              <p className="tooltip-description">{activeRegion.description}</p>
                            )}
                          </div>
                        </div>
                      </foreignObject>
